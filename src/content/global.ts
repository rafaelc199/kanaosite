...
export const about = {
  ...
  body: {
    pt: [
      "No estúdio KANAO, acreditamos que um espaço bem projetado vai muito além daquilo que se vê — deve ser uma experiência sensorial, refletindo a forma como é pensado e vivido.",
      "Cada projeto nasce da escuta, da visão e da forma de habitar de cada cliente.",
      "Criamos interiores que se revelam através da luz, da matéria, das proporções e dos detalhes, onde cada elemento é cuidadosamente escolhido para alcançar um equilíbrio entre design e funcionalidade.",
